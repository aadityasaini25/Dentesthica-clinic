  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden select-none">
      ...
      <div className="absolute top-1/4 right-[10%] opacity-20 soft-float" style={{ animationDelay: '1s' }}>
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="text-[#2a7ab5]">
      ...
      <div className="absolute bottom-1/3 left-[5%] opacity-15 soft-float" style={{ animationDelay: '3s' }}>
        <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="text-[#1a3a5c]">
