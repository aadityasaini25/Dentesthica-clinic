  ...
  return (
    <section className="relative bg-gradient-to-b from-white via-[#f8fafc] to-white py-24 md:py-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        ...
        {/* Credentials showcase strip */}
        <div className="text-center mb-10">
          <p className="text-[10px] md:text-xs font-black tracking-[0.32em] uppercase text-[#a8862a] mb-3">
            Academic & Professional Credentials
          </p>
          <h4 className="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight">
            Endorsed by the world&rsquo;s leading dental institutions
          </h4>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-5">
          {credentials.map((c, i) => (
            <div
              key={c.short}
              className="relative p-5 md:p-6 rounded-2xl bg-white card-3d-subtle group/cert overflow-hidden fade-up"
              style={{
                border: "1px solid rgba(212,175,55,0.18)",
                boxShadow:
                  "0 4px 20px rgba(26,58,92,0.04), inset 0 1px 0 rgba(255,255,255,0.8)",
            ...
            >
              ...
              <div
                className="absolute -right-4 -bottom-4 text-[100px] font-black opacity-[0.04] leading-none pointer-events-none select-none"
                style={{ fontFamily: "var(--font-poppins)" }}
              >
                {c.short.charAt(0)}
              </div>
              ...
              <p className="text-xl md:text-2xl font-black text-gradient-teal mb-1.5 tracking-tight">
                {c.short}
              </p>
              <p className="text-xs md:text-sm text-gray-600 font-medium leading-snug">
                {c.full}
              </p>
            </div>
          ))}
